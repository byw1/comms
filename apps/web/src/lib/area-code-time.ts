...
function assign(zone: string, codes: string[]) {
  for (const c of codes) {
    // A code listed under two zones would silently take whichever ran last,
    // which is how you end up confidently showing someone the wrong local
    // time. Fail loudly in development instead.
    if (AREA_CODE_ZONE[c] && AREA_CODE_ZONE[c] !== zone) {
      throw new Error(`area code ${c} assigned to both ${AREA_CODE_ZONE[c]} and ${zone}`);
    }
    AREA_CODE_ZONE[c] = zone;
  }
}
...
assign('America/Chicago', [
  ...
  '319','320','325','326','331','334','337','346','361','363','364','402','405','409','414',
  '417','430','432','469','479','501','502','504','507','512','515','531','534','538','563',
  '570','573','580','601','605','606','608','612','615','618','620','630','636','641','651','660',
  '662','681','682','708','712','713','715','726','737','763','769','773','779','785','806',
...
assign('America/New_York', [
  ...
  '272','276','301','302','304','305','313','315','321','330','332','336','339','347','351',
...
/** Every area code we know, for tests that guard against duplicates. */
export const KNOWN_AREA_CODES = AREA_CODE_ZONE;
